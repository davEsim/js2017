...
(function ($, undefined) {
	...
	var from = [
        'á', 'Á', 'ä', 'Ä', 'č','Č', 'ď', 'Ď', 'é', 'É','ě', 'Ě', 'ë', 'Ë', 'í','Í', 'i', 'I', 'ľ', 'Ą','ĺ', 'Ĺ', 'ň', 'Ň', 'ń','Ń', 'ó', 'Ó', 'ö', 'Ö',
        'ř', 'Ř', 'ŕ', 'Ŕ', 'š','Š', 'ś', 'Ś', 'ť', 'Ť','ú', 'Ú', 'ů', 'Ů', 'ü','Ü', 'ý', 'Ý', 'y', 'Y','ž', 'Ž', 'ź', 'Ź'
	];

	var to = [
        'a', 'A', 'a', 'A', 'c','C', 'd', 'D', 'e', 'E','e', 'E', 'e', 'E', 'i','I', 'i', 'I', 'l', 'L','l', 'L', 'n', 'N', 'n','N', 'o', 'O', 'o', 'O',
        'r', 'R', 'r', 'R', 's','S', 's', 'S', 't', 'T','u', 'U', 'u', 'U', 'u','U', 'y', 'Y', 'y', 'Y','z', 'Z', 'z', 'Z'
	];
	
	var string = '';
	
	function convert (text) {
		string = str_replace(from, to, text);
		return string;
	}
